...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("bitquark:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No BitQuark application found.\nPlease install BitQuark Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=altcoinservices.bitquark.wallet"));
