...
import altcoinservices.bitquark.wallet.R;
...
public class Constants
{
	...
	public static final int BTC_MAX_PRECISION = 5;      //For BTQ, Maximum of 5 decimal places for BTQ
	public static final int MBTC_MAX_PRECISION = 2;     //For BTQ, maximum of 2 decimal places for mBTQ
	...
	public static final String SOURCE_URL = "https://github.com/esotericizm/" + CoinDefinition.coinInternalName.toLowerCase() + "-wallet";
	public static final String BINARY_URL = "http://code.google.com/p/bitcoin-wallet/downloads/list";
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/Esotericizm/" + CoinDefinition.coinInternalName.toLowerCase() + "j";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
    public static final String CREDITS_WEBSITE_URL = "http://www.bitquark.info/";
    public static final String CREDITS_FORUM_URL = "https://bitcointalk.org/index.php?topic=468018.0";

	public static final String CREDITS_ICON_URL = "https://bitcointalk.org/index.php?action=profile;u=2062";

	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/#!/altcoinservices";
	public static final String AUTHOR_GOOGLEPLUS_URL = "https://profiles.google.com/altcoinservices";
	...
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"AltcoinServices\"";
